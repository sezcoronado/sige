...
const DashboardPage: React.FC = () => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      description: 'Ver eventos académicos y actividades',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      path: '/calendario',
      color: 'bg-cyan-500',
      roles: ['padres', 'alumno', 'docente', 'admin'],
    },
    {
      title: 'Cuotas Escolares',
      description: 'Gestionar cuotas y pagos (Padres)',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Gestionar salarios y pagos de docentes',
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.856-1.487M15 6a3 3 0 11-6 0 3 3 0 016 0zM15 16H9m6 0a9 9 0 11-18 0 9 9 0 0118 0z" />
        </svg>
      ),
      path: '/nomina',
      color: 'bg-orange-500',
